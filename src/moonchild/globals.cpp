...
const INT16 sinus512[1024] =  /* sinustab(1024 vals) with amplitude 512 */
{
  ...
  50, 53, 56, 59, 62, 65, 68, 72,
  75, 78, 81, 84, 87, 90, 93, 96,
  99, 102, 106, 109, 112, 115, 118, 121,
  ...
  284, 287, 289, 292, 294, 297, 299, 302,
  304, 307, 310, 312, 314, 317, 319, 322,
  ...
  439, 440, 442, 443, 445, 447, 448, 450,
  451, 453, 454, 455, 457, 458, 460, 461,
  462, 464, 465, 466, 468, 469, 470, 471,
  473, 474, 475, 476, 477, 478, 479, 481,
  482, 483, 484, 485, 486, 487, 488, 489,
  489, 490, 491, 492, 493, 494, 495, 495,
  496, 497, 498, 498, 499, 500, 500, 501,
  502, 502, 503, 503, 504, 504, 505, 505,
  506, 506, 507, 507, 508, 508, 508, 509,
  509, 509, 510, 510, 510, 510, 511, 511,
  ...
  324, 322, 319, 317, 314, 312, 310, 307,
  304, 302, 299, 297, 294, 292, 289, 287,
...
UINT32  *dotbase;      // used to store the restore positions of upto 10000 pixels in
UINT32  *dotpnt;       // points to next available position in dotbase.
UINT8   *dotcolbase;
UINT8   *dotcolpnt;
...
TRIGGER_ITEM triggerlist_33[] =
{
  ...
  {18939,  720, 19959, 4200, reallymadeit_33},
  {0,0,0,0,0}
};
